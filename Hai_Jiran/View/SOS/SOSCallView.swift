        ...
        NavigationStack {
            ZStack {
                if self.call == false {
                    VStack {
                        Spacer()
                        Text("Press more than 5 second\nto activate the Group Call!")
                            .bold()
                            .foregroundColor(.red)
                        ...
                        Spacer()
                        NavigationLink(destination: LegalNoticeSOS()) {
                            Label("Legal Notice", systemImage: "exclamationmark.triangle")
                        }
                    }
                    .padding()
                }
